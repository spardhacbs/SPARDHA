...
function App() {
  ...
  return (
    <div ref={pageRef} className="site-shell">
      ...
      <footer className="site-footer"><div className="footer-brand"><img src={`${import.meta.env.BASE_URL}images/image.png`} alt="" /><span>SPARDHA 3.0</span></div><div className="footer-contact"><span><Mail size={14} /> spardhacbs@gmail.com</span><span><Phone size={14} /> +91 8304950075</span></div><div className="footer-social"><a href="https://instagram.com" aria-label="Instagram"><Instagram size={17} /></a><button onClick={() => scrollTo('home')}>Back to top <ArrowDown size={15} /></button></div></footer>
